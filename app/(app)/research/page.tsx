...
export default function ResearchPage() {
  ...
  useEffect(() => {
    // Fetch user plan to check if Research Panel is available
    fetch("/api/me/wallet")
      .then((res) => res.json())
      .then((data) => {
        if (data.balance) {
    ...
    <div className="space-y-6">
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3 flex-1">
              <h3 className="text-sm font-medium text-yellow-800 dark:text-yellow-200">
                Research Panel Locked
              </h3>
              <div className="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                <p>Research Panel is only available for Starter and Pro plans. Upgrade to unlock this feature.</p>
              </div>
              <div className="mt-4">
                <Link
                  href="/pricing"
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 space-y-4">
        ...
        <button
          ...
          disabled={isLoading || !question.trim() || selectedExperts.length < 2 || isLocked}
